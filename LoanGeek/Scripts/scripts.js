...
/* Change the overflow:scroll to overflow hidden on the Features list */
	$('#featured_work').css('overflow','hidden');

/* Initiate the cycle on the Features list */
	$('#featured_work ul').cycle();
});
/** END CYCLE CODE **/

/**IMAGE SPOTLIGHT**/
$(document).ready(function(){
$(".portfolio li").fadeTo("slow", 0.7); // The value 0.7 sets the opacity of the thumbs to fade down to 60% when the page loads
